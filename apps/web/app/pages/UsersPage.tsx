...
import type { UserResponse, UpdateUserDto } from '@task-management/shared-types';
    ...
    <div style={{ maxWidth: '800px', margin: '50px auto', padding: '20px' }}>
      ...
      <div style={{ marginTop: '30px', padding: '15px', background: '#f0f9ff', borderRadius: '4px', border: '1px solid #0ea5e9' }}>
        ...
        <p style={{ fontSize: '14px', margin: '5px 0' }}>
          All user data is typed with <code>UserResponse</code> from <code>@task-management/shared-types</code>
        </p>
        <p style={{ fontSize: '14px', margin: '5px 0' }}>
